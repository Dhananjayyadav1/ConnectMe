    ...
    {pinDetails && (
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2 items-center">
              <a
                ...
                download
                className="bg-secondaryColor p-2 text-xl rounded-full flex items-center justify-center text-dark opacity-75 hover:opacity-100 hover:shadow-md outline-none"
              >
      ...
      {pins?.length > 0 && (
        <h2 className="text-center font-bold text-2xl mt-8 mb-4">
          More from category - <span className=''>{pinDetails?.category}</span>
        </h2>
      )}
      {pins ? (
